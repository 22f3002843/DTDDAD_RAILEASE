<template>
  <AppLayout>
    <div class="max-w-7xl mx-auto space-y-8">
      <!-- Greeting Header (Wireframe 3 Top Header) -->
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-xs text-slate-500 mt-1 font-medium">
            Here is your live journey intelligence dashboard for today.
          </p>
        </div>

        <button
          @click="router.push('/search')"
          class="px-5 py-2.5 bg-rail-500 hover:bg-rail-600 text-white rounded-btn font-semibold text-xs shadow-md hover:shadow-lg transition-all flex items-center gap-2"
        >
        ...
        <div class="lg:col-span-8 bg-white p-6 rounded-card border border-slate-200/80 shadow-soft flex flex-col justify-between">
          ...
          <div class="grid grid-cols-5 gap-3 my-6">
            <button
              ...
              :class="[
                'flex flex-col items-center justify-center p-4 rounded-card border transition-all group',
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8 bg-white p-6 rounded-card border border-slate-200/80 shadow-soft space-y-4">
          <div class="flex items-center justify-between">
            ...
            <button @click="router.push('/bookings')" class="text-xs font-semibold text-rail-500 hover:underline">
              View All Bookings
            </button>
          </div>
        ...
        <div class="lg:col-span-4 bg-white p-6 rounded-card border border-slate-200/80 shadow-soft flex flex-col justify-between">
          ...
          <div class="grid grid-cols-2 gap-3">
            <button
              ...
              class="p-4 bg-slate-50 hover:bg-rail-50 border border-slate-200/60 rounded-card flex flex-col items-center justify-center text-center transition-all group"
            >
      ...
      <div class="bg-white p-6 rounded-card border border-slate-200/80 shadow-soft">
        <div class="flex items-center justify-between mb-4">
          ...
          <button @click="router.push('/live-status')" class="text-xs font-semibold text-rail-500 hover:underline">
            View All Corridors
          </button>
        </div>
